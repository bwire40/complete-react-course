...
function EditEmployee() {
  ...
  return (
    <>
      ...
      rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white f
      ocus:border-purple-500"
                  id="name"
                  type="text"
                  value="Jane Doe"
                />
      ...
      ocus:border-purple-500"
        ...
        <Modal.Footer>
          <button
            onClick={handleClose}
            className="px-4 py-1 text-sm text-slate-600 font-semibold rounded-full border 
      border-purple-200 hover:text-white hover:bg-slate-600 hover:border-transparent 
